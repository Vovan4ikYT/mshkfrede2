...
backgrounds = {
    "phonm1": pygame.transform.scale(pygame.image.load("screens/phonm1.jpg"), (screen_width, screen_height)),
    "police_station": pygame.transform.scale(pygame.image.load("screens/police_station.png"), (screen_width, screen_height)),
    "wiliam_house": pygame.transform.scale(pygame.image.load("screens/wiliam_house.png"), (screen_width, screen_height)),
    "afton_house_gg": pygame.transform.scale(pygame.image.load("screens/afton_house_gg.png"), (screen_width, screen_height))
}
